...
@tf_export(v1=["train.BlockAdamOptimizer"])
class BlockAdamOptimizer(optimizer.Optimizer):
  ...
  def __init__(self,
               ...
               use_locking=False,
               name="BlockAdam"):
    r"""Construct a new BlockAdam optimizer.
    Initialization:
    ...
    @end_compatibility
    """
    super(BlockAdamOptimizer, self).__init__(use_locking, name)
