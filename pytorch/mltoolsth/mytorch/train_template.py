...
from mltoolsth.mytorch import mri
from mltoolsth.mytorch import loss
from mltoolsth.mytorch import optim
from mltoolsth.mytorch.tensor_ops import center_crop
...
def postprocess(tensor, shape):
    ...
    """
    if tensor.shape[-1] == 2:
        tensor = mri.root_sum_of_squares(tensor, dim=(1, -1), eps=1e-9)
