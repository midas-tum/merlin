...
class MagnitudeAveragePool1D(MagnitudeAveragePool):
    def __init__(self, kernel_size, stride=(2, 2), padding=(0, 0), dilation=(1, 1), return_indices=False, padding_mode='SAME', optox=True, layer_name='MagnitudeAvgPool1D', alpha=1, beta=1, **kwargs):
...
class MagnitudeAveragePool2D(MagnitudeAveragePool):
    def __init__(self, kernel_size, stride=(2, 2), padding=(0, 0), dilation=(1, 1), return_indices=False, padding_mode='SAME', optox=True, layer_name='MagnitudeAvgPool2D', alpha=1, beta=1, **kwargs):
        super().__init__(kernel_size, stride, padding, dilation, return_indices, padding_mode, optox, layer_name, alpha, beta, **kwargs)
        self.op = optoth.averagepooling.Averagepooling2dFunction


class MagnitudeAveragePool3D(MagnitudeAveragePool):
    def __init__(self, kernel_size, stride=(2, 2, 2), padding=(0, 0, 0), dilation=(1, 1, 1), return_indices=False, padding_mode='SAME', optox=True, layer_name='MagnitudeAvgPool3D', alpha=1, beta=1, **kwargs):
        super().__init__(kernel_size, stride, padding, dilation, return_indices, padding_mode, optox, layer_name, alpha, beta, **kwargs)
        self.op = optoth.averagepooling.Averagepooling3dFunction


class MagnitudeAveragePool2Dt(MagnitudeAveragePool):
    def __init__(self, kernel_size, stride=(2, 2, 2), padding=(0, 0, 0), dilation=(1, 1, 1), return_indices=False, padding_mode='SAME', optox=True, layer_name='MagnitudeAvgPool2Dt', alpha=1, beta=1, **kwargs):
        super().__init__(kernel_size, stride, padding, dilation, return_indices, padding_mode, optox, layer_name, alpha, beta, **kwargs)
        self.op = optoth.averagepooling.Averagepooling3dFunction


class MagnitudeAveragePool3Dt(MagnitudeAveragePool):
    def __init__(self, kernel_size, stride=(2, 2, 2, 2), padding=(0, 0, 0, 0), dilation=(1, 1, 1, 1), return_indices=False, padding_mode='SAME', optox=True, layer_name='MagnitudeAvgPool3Dt', alpha=1, beta=1, **kwargs):
        super().__init__(kernel_size, stride, padding, dilation, return_indices, padding_mode, optox, layer_name, alpha, beta, **kwargs)
