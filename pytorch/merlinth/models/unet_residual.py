...
#         print(model)
#         x = torch.randn(D, M, N, 2).cuda()
#         model.cuda()
#         Kx = model(x)
#         print(f'{ortho} {mode} {activation} Kx: ', Kx.min(), Kx.max())

    # def test_complex_init_1(self):
    #     self._test_complex_init(3, 3, 32, 'he', 'ModReLU', False)
    # def test_complex_init_2(self):
    #     self._test_complex_init(3, 3, 32, 'he', 'cPReLU', False)
    # def test_complex_init_3(self):
    #     self._test_complex_init(3, 3, 32, 'glorot', 'ModReLU', False)
    # def test_complex_init_4(self):
    #     self._test_complex_init(3, 3, 32, 'glorot', 'cPReLU', False)
    # def test_complex_init_1_ortho(self):
    #     self._test_complex_init(3, 3, 32, 'he', 'ModReLU', True)
    # def test_complex_init_2_ortho(self):
    #     self._test_complex_init(3, 3, 32, 'he', 'cPReLU', True)
    # def test_complex_init_3_ortho(self):
    #     self._test_complex_init(3, 3, 32, 'glorot', 'ModReLU', True)
    # def test_complex_init_4_ortho(self):
    #     self._test_complex_init(3, 3, 32, 'glorot', 'cPReLU', True)
    # def test_complex_init_5_ortho(self):
    #     self._test_complex_init(3, 3, 32, 'glorot', 'ReLU', True)
